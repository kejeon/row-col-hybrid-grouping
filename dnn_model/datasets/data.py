...
data_root2 = '/root/data2/jk/MetaNet_ws/data/' # for rack 1
data_root3 = '/root/data1/kejeon/' # for rack 5
data_root4 = '/root/data1/datasets/' # for rack 2
data_root_imagenet = data_root3
data_paths = {
    ...
    'imagenet': {
        'train': os.path.join(data_root_imagenet, 'imagenet/train'),
        'val': os.path.join(data_root_imagenet, 'imagenet/val')
    }
    # 'imagenet': {
    #     'train': os.path.join(data_root4, 'ImageNet-C/train'),
    #     'val': os.path.join(data_root4, 'ImageNet-C/val')
    # }
}
